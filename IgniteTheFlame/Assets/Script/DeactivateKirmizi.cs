...
public class DeactivateKirmizi : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        Debug.Log("redstone: " + PublicValues.redStone);
        if (!String.IsNullOrEmpty(tagFilter) && other.gameObject.CompareTag(tagFilter) && PublicValues.redStone == true)
        {
