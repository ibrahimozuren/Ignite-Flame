...
public class DeactivateMavi : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        //Debug.Log("redstone: " + PublicValues.blueStone);
        if (!String.IsNullOrEmpty(tagFilter) && other.gameObject.CompareTag(tagFilter) && PublicValues.blueStone == true)
        {
